<?php
/*
 * GrapAgenda :: ADMINISTRATION
 * Version 0.9 Beta
 * Auteur : GUNNING Sky
 */

define('IN_WWW', 1); // ne pas toucher ceci
define('IN_ADMIN', 1); // ne pas toucher ceci
...
// check admin rights
if(!$_IsAdmin)
    exit('Accès restreinte : uniquement administrateur.');
...
<body>
    ...
    <div id="conteneur">
        ...
        <table width="980" border="0" align="center" class="cadre">
            <tr valign="top">
